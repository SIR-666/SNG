...
int urutan_200C[11] = {8, 9, 0, 1, 4, 7, 2, 5, 10, 6 };//{0, 1, 7, 8, 3, 6, 9, 4, 2, 5 };
int urutan_100C[11] = {8, 9, 0, 1, 3, 7}; // {0, 1, 7, 8, 10, 6 };
...
void setup() {
  ...
  */
  ...
  pinMode(lam1Jig2, OUTPUT);
  pinMode(lam2Jig2, OUTPUT);
...
void loop() {
  ...
  //Serial.print(" | ");
  Serial.print(digitalRead(jig_teta));
